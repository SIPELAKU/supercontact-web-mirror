  ...
  return (
    <main className="min-h-screen flex flex-col items-center w-full md:w-1/3 bg-gray-50">
      ...
      <section className="flex flex-col h-full justify-center px-8 md:px-20 py-10 bg-white">
        ...
        <span className="text-md text-gray-500 mt-2 text-center">Kami telah mengirimkan 6 digit OTP ke: email@*********com</span>

        <form className="mt-6 space-y-4">
          <div>
            <label className="block text-sm font-medium text-gray-700">Masukan kode OTP</label>
            <input
              type="email"
          ...
          <p className="mt-2 text-sm text-center justify-center text-gray-600">
            Tidak menerima kode? {" "}
