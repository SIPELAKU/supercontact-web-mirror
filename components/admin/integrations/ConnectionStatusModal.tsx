...
import { useIntegrationConnectionLog } from "@/lib/hooks/useIntegrations";
...
const ConnectionStatusModal: React.FC<ConnectionStatusModalProps> = ({
    ...
    const { data: logResponse, isLoading, error, refetch } = useIntegrationConnectionLog(integrationId, open);
            ...
            >
                <div className="p-6 border-b border-gray-100 flex items-center gap-3">
                    ...
                    <h2 className="text-xl font-semibold text-gray-900">
                        Connection Status: {providerName}
                    </h2>
                </div>
                ...
                <div className="p-6 space-y-4">
                    {isLoading ? (
                        ...
                        <div className="text-center py-8 text-gray-500">
                            This integration has never been tested for connection.
                        </div>
                    ) : (
                        <>
