...
export default function MarketingHero() {
    ...
    return (
        <PageHero
            badge={strings.formatString(strings.hero_slide_badge_solusi, strings.sol_role_marketing)}
            title={strings.sol_mkt_hero_title}
            description={strings.sol_mkt_hero_desc}
            trackSource="solusi/marketing"
