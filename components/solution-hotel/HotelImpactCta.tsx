...
export default function HotelImpactCta() {
    ...
    const metrics = [
        { val: strings.hotel_impact1_val, desc: strings.hotel_impact1_desc, color: 'var(--brand-deep)' },
        { val: strings.hotel_impact2_val, desc: strings.hotel_impact2_desc, color: 'var(--brand-deep)' },
        { val: strings.hotel_impact3_val, desc: strings.hotel_impact3_desc, color: 'var(--brand-deep)' },
        { val: strings.hotel_impact4_val, desc: strings.hotel_impact4_desc, color: 'var(--brand-deep)' }
    ];
            ...
            <Box sx={{ bgcolor: 'var(--brand-deep)', py: { xs: 10, md: 14 } }}>
                <Container maxWidth="md">
                    <Box sx={{ textAlign: 'center' }}>
                        ...
                        >
                            {strings.hotel_cta_title}
                        </Typography>
                        <Typography
                            variant="body1"
                            sx={{ color: 'rgba(255,255,255,0.9)', mb: 6, fontSize: { xs: '1rem', md: '1.25rem' }, lineHeight: 1.7 }}
                        >
                            {strings.hotel_cta_desc}
                        </Typography>
                        <Button
                            variant="contained"
                            component={Link}
                            href="/register"
                            onClick={() => trackCtaClick('solusi/perhotelan', 'impact_cta')}
                            sx={{
                                bgcolor: 'white',
