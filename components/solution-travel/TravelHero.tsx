...
export default function TravelHero() {
    ...
    return (
        <PageHero
            badge={strings.formatString(strings.hero_slide_badge_solusi, strings.sol_ind_travel)}
            title={strings.travel_hero_title}
            description={strings.travel_hero_desc}
            trackSource="solusi/tour-travel"
            secondaryCta={{
                label: strings.travel_hero_btn_consult,
                href: getWhatsAppLink('/solusi/tour-travel'),
                external: true,
                icon: <WhatsAppIcon />,
...
export function TravelHeroVisual() {
    return (
