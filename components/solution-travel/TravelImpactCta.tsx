...
export default function TravelImpactCta() {
    ...
    const metrics = [
        { val: strings.travel_impact1_val, desc: strings.travel_impact1_desc, color: 'var(--brand-deep)' },
        { val: strings.travel_impact2_val, desc: strings.travel_impact2_desc, color: 'var(--brand-deep)' },
        { val: strings.travel_impact3_val, desc: strings.travel_impact3_desc, color: 'var(--brand-deep)' },
        { val: strings.travel_impact4_val, desc: strings.travel_impact4_desc, color: 'var(--brand-deep)' }
    ];
