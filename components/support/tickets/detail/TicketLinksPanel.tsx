...
import { TICKET_LINK_TYPE_LABELS } from "@/lib/types/Ticket";
...
export function TicketLinksPanel({ ticketId }: TicketLinksPanelProps) {
    ...
    return (
        <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            <h4 className="mb-3 text-xs font-bold uppercase text-gray-400">Linked Tickets</h4>
                ...
                {links.map((link) => (
                    ...
                    >
                        <div className="min-w-0">
                            <span className="mr-2 shrink-0 rounded bg-gray-100 px-1.5 py-0.5 text-[11px] font-semibold uppercase tracking-wide text-gray-500">
                                {TICKET_LINK_TYPE_LABELS[link.link_type] ?? link.link_type}
                            </span>
                            <Link
