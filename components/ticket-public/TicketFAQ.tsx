    ...
    id: {
        ...
        faqs: [
            ...
            },
            {
                ...
                a: 'Klik tombol WhatsApp di halaman ini untuk terhubung langsung dengan tim kami. Kami akan bantu memahami alur eskalasi dan SLA tim CS Anda saat ini, lalu menjelaskan langkah-langkah selanjutnya.',
            },
        ],
    },
    en: {
        ...
        faqs: [
            ...
            },
            {
                ...
                a: 'Click the WhatsApp button on this page to connect directly with our team. We\'ll help understand your CS team\'s current escalation flow and SLA needs, then walk you through the next steps.',
            },
        ],
    },
};
                    ...
                    {t.faqs.map((faq, index) => (
                        ...
                        >
                            <AccordionSummary
                                ...
                                aria-controls={`ticket-faq-panel${index}-content`}
                                id={`ticket-faq-panel${index}-header`}
                                sx={{ px: 3, py: 1 }}
                            >
