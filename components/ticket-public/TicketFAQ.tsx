    ...
    id: {
        ...
        faqs: [
            ...
            },
            {
                ...
                a: 'Cara tercepat: daftar trial gratis secara mandiri di smartsales.id/register (tanpa kartu kredit, masa trial 30 hari). Ingin didampingi? Klik tombol WhatsApp di halaman ini — tim kami bantu memahami alur eskalasi dan SLA tim CS Anda saat ini, lalu menjelaskan langkah selanjutnya.',
            },
        ],
    },
    en: {
        ...
        faqs: [
            ...
            },
            {
                ...
                a: 'The fastest way: sign up for the free trial yourself at smartsales.id/register (no credit card, 30-day trial). Prefer guidance? Click the WhatsApp button on this page — our team will help map your CS team\'s current escalation flow and SLA needs, then walk you through the next steps.',
            },
        ],
    },
};
