...
export const strings = createLocalizedStrings({
    en: {
        ...
        fmcg_cta_desc: "Every order from a store is valuable. Ensure no orders are missed and no complaints are left hanging by automating your distributor operations with SmartSales.",
    ...
    id: {
        ...
        fmcg_cta_desc: "Setiap order dari toko sangat berharga. Pastikan tidak ada pesanan yang terlewat dan keluhan yang menggantung dengan mengotomatiskan operasional distributor Anda bersama SmartSales.",
